...
import '../services/task_storage_service.dart'; // Import the service

class TaskViewModel extends ChangeNotifier {
  final List<TaskModel> _tasks = [];
  final TaskStorageService _storage = TaskStorageService(); // Initialize service
  String _searchQuery = '';
  ...
  Future<void> loadFromDisk() async {
    ...
    for (var item in storedData) {
      _tasks.add(TaskModel(
        ...
        priority: TaskPriority.values[item['priority']], // Convert index back to Enum
  ...
  void addTask(String title, TaskPriority priority) {
    ...
    _tasks.add(newTask);
    _storage.saveTasks(_tasks); // Save to Hive
    notifyListeners();
  }
